...
<section class="post-related-articles czr-carousel <?php czr_fn_echo('element_class') ?>" <?php czr_fn_echo('element_attributes') ?>>
  <header class="row flex-row">
    <h3 class="related-posts_title col"><?php _e('Vous pourriez aussi aimer', 'strasbourg') ?></h3>
    ...
    ?>
      <div class="related-posts_nav col col-auto">
        <span class="btn btn-skin-dark inverted czr-carousel-prev slider-control czr-carousel-control disabled <?php echo $_icon_prev ?>" title="<?php esc_attr_e('Articles précédents', 'strasbourg')?>" tabindex="0"></span>
        <span class="btn btn-skin-dark inverted czr-carousel-next slider-control czr-carousel-control <?php echo $_icon_next ?>" title="<?php esc_attr_e('Articles suivants', 'strasbourg')?>" tabindex="0"></span>
      </div>
    <?php endif ?>
  </header>
