                ...
                switch ( $input_type ) {
                    ...
                    case 'tiny_mce_editor' :
                        ?>
                          ...
                          <button type="button" class="button text_editor-button" data-czr-control-id="{{ data.control_id }}" data-czr-input-id="<?php echo $input_id; ?>" data-czr-action="close-tinymce-editor"><?php _e('Hide editor', 'customizr-pro' ); ?></button>
...
if ( ! class_exists( 'CZR_Fmk_Base' ) ) :
    class CZR_Fmk_Base extends CZR_Fmk_Dyn_Module_Registration {
      ...
      public function ajax_search_available_items() {
            ...
            if ( empty( $items ) ) {
                wp_send_json_error( array( 'message' => __( 'No results found.', 'customizr-pro') ) );
            } else {
                wp_send_json_success( array(
